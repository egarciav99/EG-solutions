...
export const CASE_STUDIES: ProjectCase[] = [
  {
    ...
    scaleLabel: 'Propuesta técnica en evaluación',
    clientContext:
      'Propuesta técnica y demo funcional desarrollada para participar en la selección de proveedor de una activación nacional de marca de bebidas durante una temporada deportiva de alto perfil.',
    summary:
    ...
    problem:
      'Las aplicaciones tradicionales de descarga en campañas masivas suelen presentar una caída drástica en el embudo de acceso debido a la barrera de instalación en tiendas de aplicaciones. Además, el canje presencial en sucursales requiere evitar canjes duplicados o capturas de pantalla fraudulentas sin complejizar la operación de los cajeros.',
    solution:
    ...
    keyHighlights: [
      ...
      'Cero descargas requeridas: acceso inmediato vía QR en empaque y material POP'
    ],
    techStack: [
      'TypeScript',
      'React',
  ...
  },
  {
    ...
    scaleLabel: 'Proyecto contratado — en especificación',
    clientContext:
      'Negocio especializado en carritos de snacks y catering temático para bodas, cumpleaños y eventos corporativos. Proyecto contratado, actualmente en fase de recopilación de requerimientos (catálogo, precios, identidad visual) antes de iniciar el desarrollo.',
    summary:
    ...
    problem:
      'La gestión manual por mensajería instantánea provoca retrasos de horas en enviar presupuestos, riesgo de doble reserva de un mismo carrito para el mismo fin de semana y falta de visibilidad del stock de insumos por evento.',
    solution:
      'Un cotizador interactivo transparente donde el cliente seleccionará tipo de estación, número de personas, horas de servicio y complementos, recibiendo el presupuesto desglosado al instante. Al confirmar, el sistema bloqueará automáticamente la disponibilidad del inventario físico y notificará a ambas partes.',
    keyHighlights: [
      'Cotización automática instantánea diseñada para reemplazar el ciclo manual actual de presupuestos por mensajería',
      'Motor de disponibilidad de inventario físico planeado para prevenir solapamiento de fechas y equipos',
    ...
    architecturePoints: [
      ...
      'Reglas de seguridad en base de datos para aislar pedidos y proteger datos de contacto de clientes',
  ...
  },
  {
    ...
    scaleLabel: 'Propuesta técnica en evaluación',
    clientContext:
      'Hub de automatización desarrollado como propuesta técnica para una empresa de servicios técnicos y consultoría, con el objetivo de resolver la carga manual de transcripción de documentos operativos.',
    summary:
    ...
    problem:
      'La transcripción manual de comprobantes, facturas de compras e informes técnicos a hojas de cálculo consume tiempo considerable de personal calificado y es propensa a errores tipográficos en montos y números de serie.',
    solution:
    ...
    keyHighlights: [
      ...
      'Diseñado para reducir significativamente el tiempo de procesamiento administrativo semanal, con trazabilidad total de auditoría'
    ],
    techStack: [
      'Python',
      'Google Gemini API',
